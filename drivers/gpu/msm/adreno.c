...
/*Default		device->pwrctrl.pm_qos_active_latency = 1000; */

		device->pwrctrl.pm_qos_active_latency = 401;
...
/*default		device->pwrctrl.pm_qos_cpu_mask_latency = 1000;*/

		device->pwrctrl.pm_qos_cpu_mask_latency = 401;
...
*/
		device->pwrctrl.pm_qos_wakeup_latency = 1;
